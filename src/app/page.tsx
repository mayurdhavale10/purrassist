...
export default function Home() {
  ...
  // --- Audio setup (autoplay-safe) ---
  useEffect(() => {
    const a = audioRef.current;
    if (!a) return;
    a.volume = 1.0;   // louder
    a.muted = true;   // autoplay requires muted at render
    a.play().catch(() => {});
  }, []);
  ...
  // --- Scroll reveal for story cards ---
  useEffect(() => {
    const cards = document.querySelectorAll<HTMLElement>(".reveal-on-scroll, .scroll-animate");
  ...
  return (
    <>
      ...
      <main className="min-h-[calc(100vh-5rem)] w-full flex flex-col items-center justify-start relative overflow-hidden pt-10 md:pt-12">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h1 className="mt-6 text-center text-2xl md:text-3xl font-extrabold tracking-tight animate-fade-in-up animation-delay-200">
            <span className="text-teal-600">Verified College Video Chat</span>
            <span className="text-slate-900"> – Real Students, Real Connections</span>
          </h1>

          <p className="mt-3 max-w-2xl text-center text-slate-700 animate-fade-in-up animation-delay-400">
            Meet classmates from your campus or explore verified students across the globe.
            <span className="text-blue-700 font-medium"> No bots, no creeps</span> — just
            ...
            <div className="relative h-10 md:h-12 [mask-image:linear-gradient(to_right,transparent,black_12%,black_88%,transparent)]">
              <div className="marquee whitespace-nowrap">
                <span className="mx-6 font-semibold">
                  Connect • Vibe • Enjoy • Connect • Vibe • Enjoy • Connect • Vibe • Enjoy
                </span>
                <span className="mx-6 font-semibold">
                  Connect • Vibe • Enjoy • Connect • Vibe • Enjoy • Connect • Vibe • Enjoy
                </span>
        ...
        <section className="relative z-10 w-full max-w-6xl mx-auto mt-12 px-4 scroll-animate fade-in">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <article className="reveal-on-scroll card-base border-t-4 border-teal-400 bg-teal-50" data-card="teal">
              <div className="card-accent teal"></div>
              <header className="flex items-center gap-3 mb-3">
                <span className="text-2xl">🤝</span>
                <h3 className="font-semibold text-lg text-teal-700">New Connection</h3>
              </header>
              <p className="text-slate-700">
                Soham from <strong>Shah Anchor</strong> just connected with <strong>Tanvi</strong> from <strong>VIT Wadala</strong>.
              </p>
            </article>

            <article className="reveal-on-scroll card-base border-t-4 border-pink-400 bg-pink-50" data-card="pink">
              <div className="card-accent pink"></div>
              <header className="flex items-center gap-3 mb-3">
                <span className="text-2xl">🌏</span>
                <h3 className="font-semibold text-lg text-pink-700">Cultural Exchange</h3>
              </header>
              <p className="text-slate-700">
                Viraj from <strong>KJ Somaiya</strong> and <strong>Babita</strong> from <strong>Suvidya Institute</strong> discussing cultural exchange.
              </p>
            </article>

            <article className="reveal-on-scroll card-base border-t-4 border-yellow-400 bg-yellow-50" data-card="yellow">
              <div className="card-accent yellow"></div>
              <header className="flex items-center gap-3 mb-3">
                <span className="text-2xl">🏋️‍♂️</span>
                <h3 className="font-semibold text-lg text-yellow-700">Gym Session</h3>
              </header>
              <p className="text-slate-700">
                Kartik from <strong>VIT Wadala</strong> and <strong>Smith</strong> joined a gym session.
              </p>
            </article>
          </div>
        </section>
        ...
        <section className="relative z-10 w-full max-w-3xl mx-auto mt-12 px-4 scroll-animate slide-left">
          <div className="rounded-3xl border bg-gradient-to-b from-emerald-50 via-slate-50 to-blue-50 shadow-md p-4 md:p-6">
            ...
            <div className="mb-5 flex items-end gap-3">
              <div className="h-10 w-10 rounded-full bg-teal-300/70 flex items-center justify-center text-white text-sm font-semibold">A</div>
              <div className="chat-bubble bubble-left">
                <div className="text-xs text-slate-500 mb-1">Feature 1 • College → College</div>
                ...
                <p className="mt-2 text-sm text-slate-700">
                  Connect and communicate exclusively with peers from your own college.
                </p>
                <div className="mt-1 text-[11px] text-slate-500">Seen • 7:42 PM</div>
              </div>
            </div>
            ...
            <div className="mb-5 flex items-end gap-3 justify-end">
              <div className="chat-bubble bubble-right">
                <div className="text-xs text-slate-600 mb-1">Feature 2 • Inter-College</div>
                <div className="rounded-xl overflow-hidden ring-1 ring-black/5">
                  <video
                ...
                <p className="mt-2 text-sm text-slate-700">
                  Connect with verified students from other colleges—network, chat, and have fun!
                </p>
                <div className="mt-1 text-[11px] text-slate-600">Delivered • 7:44 PM</div>
              </div>
              <div className="h-10 w-10 rounded-full bg-emerald-400/80 flex items-center justify-center text-white text-sm font-semibold">U</div>
            </div>

            {/* Message 3: Received (left) - NEW */}
            <div className="mb-2 flex items-end gap-3">
              <div className="h-10 w-10 rounded-full bg-purple-300/70 flex items-center justify-center text-white text-sm font-semibold">A</div>
              <div className="chat-bubble bubble-left">
                <div className="text-xs text-slate-500 mb-1">Feature 3 • Global Connect</div>
                <div className="rounded-xl overflow-hidden ring-1 ring-black/5">
                  <video
                ...
                <div className="mt-2 text-sm text-slate-700 space-y-1">
                  <p><strong>Feeling social?</strong> <strong>&apos;Badmosi karni hai?&apos;</strong> Switch to <em>Boys Mode</em> and squad up!</p>
                  <p><strong>Want women-only conversations?</strong> <strong>&apos;Mahila mitra banani hai?&apos;</strong> Select <em>&apos;Girls Mode&apos;</em> for a comfortable space.</p>
                  <p className="text-xs italic text-slate-600">Sab verified, sab safe – &apos;apni marzi ka vibe chuno!&apos;</p>
                </div>
                <div className="mt-1 text-[11px] text-slate-500">Seen • 7:46 PM</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="relative z-10 w-full max-w-4xl mx-auto mt-16 px-4 scroll-animate slide-up">
          <div className="text-center bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 rounded-3xl p-8 md:p-10 border border-purple-100 shadow-lg">
            ...
            <p className="text-lg text-slate-700 max-w-2xl mx-auto mb-6">
              We handpick the best cafés, study nooks, and hidden gems near your campus—so you can move from chat to chill without missing a beat.
            </p>
            ...
            <div className="text-left max-w-2xl mx-auto mb-6">
              ...
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start gap-3">
                  ...
                  Exclusive student discounts at cafés, go-karting, and shopping spots
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-500 font-bold">•</span>
                  Curated, vibe-checked spaces (quiet libraries, lively food joints, 24/7 study hubs)
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-purple-500 font-bold">•</span>
            ...
            <div className="inline-flex items-center gap-2 bg-slate-100 rounded-full px-6 py-3 border">
              ...
              <span className="text-slate-700">
                This feature is <strong>&apos;coming soon&apos;</strong>—enter your campus to get early access.
              </span>
            </div>
          </div>
        </section>
      ...
      <style jsx>{`
        ...
        .card-accent.teal { background: #5eead4; }    /* teal-300 */
        .card-accent.pink { background: #f9a8d4; }    /* pink-300 */
        .card-accent.yellow { background: #fde68a; }  /* yellow-300 */
        ...
        @media (prefers-reduced-motion: reduce) {
          .marquee { animation: none !important; white-space: normal; position: static; }
          .card-base,
          .reveal-on-scroll,
          .animate-fade-in-up,
          .scroll-animate { transition: none !important; animation: none !important; opacity: 1 !important; transform: none !important; }
          .card-accent { animation: none !important; }
        }
      `}</style>
    </>
  );
